  ...
  <div class="bg-white p-4 shadow mb-6">
    ...
    <div class="grid grid-cols-3 gap-4">
      <div>
        ...
        <input id="search" type="text" v-model="filters.searchQuery" class="border p-2 w-full"
          placeholder="Search expenses..." @input="emitFilters">
      </div>
      <div>
        <label for="group" class="block mb-2">Group:</label>
        <select id="group" v-model="filters.groupFilter" class="border p-2 w-full" @change="emitFilters">
      ...
      <div>
        ...
        <input id="month" type="month" v-model="filters.monthFilter" class="border p-2 w-full" @change="emitFilters">
      </div>
    </div>
  </div>
</template>
...
const props = defineProps({
  ...
  groupFilter: { type: Number, default: 0 },
