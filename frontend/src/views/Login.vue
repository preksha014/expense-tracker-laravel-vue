  ...
  <GuestLayout>
    <div class="flex items-center justify-center min-h-[80vh]" data-v-inspector="src/views/Login.vue:2:3">
      <div class="w-full max-w-md bg-white rounded-lg shadow-md p-8" data-v-inspector="src/views/Login.vue:3:5">
        <h2 class="text-2xl font-bold text-center text-blue-600 mb-6" data-v-inspector="src/views/Login.vue:4:7">Login
        </h2>
        <form @submit.prevent="handleLogin" class="space-y-4" data-v-inspector="src/views/Login.vue:5:7">
          <InputField id="email" label="Email" type="email" v-model="formData.email"
            :error="v$.email.$error ? v$.email.$errors[0].$message : ''" data-v-inspector="src/views/Login.vue:6:9" />
          ...
          <p v-if="errorMessage" class="text-center text-sm text-red-600 mt-4"
            data-v-inspector="src/views/Login.vue:14:9">
            {{ errorMessage }}
          </p>
          <p class="text-center text-sm text-gray-600 mt-4" data-v-inspector="src/views/Login.vue:16:9">
            ...
            <router-link to="/register" class="text-blue-600 hover:text-blue-700"
              data-v-inspector="src/views/Login.vue:18:11">
              Register here
            </router-link>
          </p>
        </form>
